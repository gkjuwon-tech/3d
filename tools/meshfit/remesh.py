# Vendored from Unique3D (MIT, (c) 2024 AiuniAI), mesh_reconstruction/remesh.py,
# itself modified from Continuous Remeshing (Palfinger, Profactor; MIT).
# Only change: torch_scatter replaced by tools/meshfit/_scatter.py (plain
# PyTorch), so nothing needs compiling. See LICENSE_THIRD_PARTY.
# modified from https://github.com/Profactor/continuous-remeshing
import torch
import torch.nn.functional as tfunc
from ._scatter import torch_scatter
